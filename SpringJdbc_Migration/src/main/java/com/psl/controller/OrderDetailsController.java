...
//		list.add(new OrderDetails("O7","A24",5,new Float(799.88),118));
//		list.add(new OrderDetails("O8","A17",4,new Float(9999.99),115));
//		list.add(new OrderDetails("O9","A18",7,new Float(3000),115));
//		list.add(new OrderDetails("O10","A99",3,new Float(788.50),111));
